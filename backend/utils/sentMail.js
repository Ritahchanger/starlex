...
const sendNewsletterToAllUtil = async ({
  subject,
  message,
  fromName = "STARLEX INNOVATION TECHNOLOGIES",
}) => {
  try {
    if (!subject || !message) {
    ...
    const summary = {
      ...
      subject: subject,
      company: "STARLEX INNOVATION TECHNOLOGIES",
    };
    console.log("🎯 Starlex Newsletter sending completed:", {
      total: summary.total,
    ...
    console.error("💥 Starlex Newsletter sending failed:", error.message);
    throw error;
  }
};
